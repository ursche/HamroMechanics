...
urlpatterns = [
    ...
    path('notifications/reject/<int:notification_id>/', views.RejectRequestAPIView.as_view()),
    path('notifications/cancel/<int:notification_id>/', views.CancelRequestAPIView.as_view()),
